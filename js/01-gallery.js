...
galleryElement.addEventListener("click", (event) => {
  ...
  //Цей код "прослуховує" подію "keydown" на клавіатурі і перевіряє, чи була натиснута клавіша "Escape". Якщо так, то він закриває модальне вікно, використовуючи метод instance.close().
  function onEsc(e) {
    if (e.code === "Escape") {
      instance.close();
    }
